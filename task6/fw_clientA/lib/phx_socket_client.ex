defmodule Task4CClientRobotA.PhoenixSocketClient do
  ...
  def send_robot_status(channel, %Task4CClientRobotA.Position{x: x, y: y, facing: facing} = robot) do
    ...
    _tup = PhoenixClient.Channel.push(channel,"new_msg",%{"client" => "robot_A","x" => x, "y" => y, "face" => facing, "obs" => is_obs_ahead},5000)
  ...
  def get_bot_position(bool,channel,robot) do
    ...
    tup = PhoenixClient.Channel.push(channel,"get_bots",%{"client" => "robot_A","x" => x, "y" => y, "face" => facing, "alive" => bool},5000)
    {:ok, rep} = tup
